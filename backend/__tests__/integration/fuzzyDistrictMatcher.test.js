// Mocks will be configured dynamically inside beforeEach

describe("Fuzzy District Matcher", () => {
    ...
    beforeEach(() => {
        ...
        // requires '../database/db', it will get this mock instead.
    ...
    test("should initialize only once when called multiple times", async () => {
        ...
        mockQuery
            .mockResolvedValueOnce({ rows: mockDistricts })
            .mockResolvedValue({ rows: mockAssembly });
